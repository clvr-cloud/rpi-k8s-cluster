...
> A template for creating new repositories in the @clvr-cloud organization

This repository is meant to serve as a general template for how to set up new repositories in the @clvr-cloud organization. In general, setting up a new repository should take only a few minutes; use this repository as a way of finding example files, and use the following checklist to ensure that you've set up the repository correctly.
...
- [ ] Is `CLVR Cloud Ltd` the licensor?
...
- [ ] Have you added topics to the GitHub repository: `clvr`, `clvr cloud`, and so on?
...
If you think this could be better, please [open an issue](https://github.com/clvr-cloud/repo-template/issues/new)!
